        ...
        <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full space-y-8">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              {isLogin ? "Enter your credentials to access your wallet" : "Sign up to start trading today"}
            </p>
          </div>
                ...
                >
                  <div className="relative">
                    ...
                    <Input 
                      ...
                      className="pl-12 h-14 bg-card/50 border-white/10 rounded-xl focus:border-primary/50 transition-colors"
                      required={!isLogin}
                    />
                  </div>
                </motion.div>
            ...
            <div className="space-y-2">
              <div className="relative">
                ...
                <Input 
                  ...
                  className="pl-12 pr-12 h-14 bg-card/50 border-white/10 rounded-xl focus:border-primary/50 transition-colors"
                  required
                />
                <button 
                  type="button"

        ...
        >
          ...
          <div className="space-y-3 max-w-xs">
            ...
            <p className="text-muted-foreground leading-relaxed">
              {isPortuguese 
                ? "O programa de indicação estará disponível em breve. Convide amigos e ganhe recompensas." 
                : "The referral program will be available soon. Invite friends and earn rewards."}
            </p>
          </div>
        </motion.div>
      </div>
